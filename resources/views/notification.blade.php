<li class="nav-item btn-check-preso dropdown text-center sizebox">
    <a href="#" class=" nav-link active notif text-center colorhover" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id="notificationsdropdown" style="display: none;">
