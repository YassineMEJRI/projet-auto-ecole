...
@section('content')
    <form>
        ...
        <input type="range" class="form-range" min="0" max="20" value="5" step="1" name="heuresCode" id="heuresCode" onchange="somme()">
        ...
        <input type="range" class="form-range" min="0" max="50" value="10" step="1" name="heuresConduite" id="heuresConduite" onchange="somme()">
